...
//    public static final int OPTION_EMPTY = 0;
    ...
    public static final int OPTION_REFACTOR_SIZE = 4;
    public static final int[] optionsInt = {OPTION_SHOW_SOFT_INPUT,OPTION_SHOW_ALL_OPTIONS,OPTION_TOGGLE_FULLSCREEN,OPTION_REFACTOR_SIZE};
...
//        optionsLoader.put(OPTION_EMPTY, EMPTY_OPTION.class);
        ...
        optionsLoader.put(OPTION_REFACTOR_SIZE, new OptionRefactorSize());
...
//        }
    ...
    @IntDef({ OPTION_SHOW_SOFT_INPUT,OPTION_SHOW_ALL_OPTIONS,OPTION_TOGGLE_FULLSCREEN,OPTION_REFACTOR_SIZE})
